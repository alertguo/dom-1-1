...
var div = dom.find('#test>.red')[0]; // 获取对应的元素,封装时不用两个参数也可以实现

console.log(div);
var divList = dom.find('.red'); // 获取多个 div.red 元素

console.log(divList);
var div2 = dom.find('.red', test2)[0];
console.log(div2);
...
},{}]},{},["C:/Users/郭高/AppData/Local/Yarn/Data/global/node_modules/parcel/src/builtins/hmr-runtime.js","main.js"], null)
